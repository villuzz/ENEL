sap.ui.define([
  ...
  return Controller.extend("PM030.APP1.controller.TabellaDestinatariCdl", {
      ...
      onSearchFilters: function () {
          ...
          var oBinding = this.byId("tbTabellaDestinatariCdl").getBinding("items");
          ...
          oData.DescrizioneDestinatario.map((dd) => {
              filterArray.push(new sap.ui.model.Filter("DescrizioneDestinatario", sap.ui.model.FilterOperator.EQ, dd));
          });
