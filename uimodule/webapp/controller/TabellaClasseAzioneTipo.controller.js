sap.ui.define([
  ...
  return Controller.extend("PM030.APP1.controller.TabellaClasseAzioneTipo", {
      ...
      onSearchFilters: function () {
          ...
          var oBinding = this.byId("tbTabellaClasseAzioneTipo").getBinding("items");
          ...
          oData.Classe.map((cl) => {
              filterArray.push(new sap.ui.model.Filter("Classe", sap.ui.model.FilterOperator.EQ, cl));
          });
          oData.Testo.map((testo) => {
              filterArray.push(new sap.ui.model.Filter("Testo", sap.ui.model.FilterOperator.EQ, testo));
          });
