sap.ui.define([
    ...
    return Controller.extend("PM030.APP1.controller.TabellaFinalita", {
        ...
        FinalitaModel: function (sValue) {
            ...
            var rValue = {
                TipoGestione1: (sValue[oResources.getText("TipoGest")] === undefined) ? "" : sValue[oResources.getText("TipoGest")].toString(),
                Divisione: (sValue[oResources.getText("Divisione")] === undefined) ? "" : sValue[oResources.getText("Divisione")].toString(),
                DesTipoGest1: (sValue[oResources.getText("Descrizione")] === undefined) ? "" : sValue[oResources.getText("Descrizione")].toString(),
        ...
        handleUploadPress: function () {
            this.handleUploadGenerico("/T_TP_MAN1");
        },
        ControlloExcelModel: function (sValue) {
            var oResources = this.getResourceBundle();
            var rValue = {
                TipoGestione1: (sValue[oResources.getText("Finalita")] === undefined) ? "" : sValue[oResources.getText("Finalita")].toString(),
                Divisione: (sValue[oResources.getText("Divisione")] === undefined) ? "" : sValue[oResources.getText("Divisione")].toString(),
                DesTipoGest1: (sValue[oResources.getText("DescrizioneFinalita")] === undefined) ? "" : sValue[oResources.getText("DescrizioneFinalita")].toString(),
                Raggruppamento: (sValue[oResources.getText("Raggruppamento")] === undefined) ? "" : sValue[oResources.getText("Raggruppamento")].toString()
            };
            return rValue;
        },
