sap.ui.define([
  ...
  return Controller.extend("PM030.APP1.controller.TabellaRaggruppamento", {
      ...
      onSearchFilters: function () {
          ...
          var oBinding = this.byId("tbRaggruppamento").getBinding("items");
          ...
          oData.Raggruppamento.map((sis) => {
              filterArray.push(new sap.ui.model.Filter("Raggruppamento", sap.ui.model.FilterOperator.EQ, sis));
          });
          oData.DescrizioneRaggruppamento.map((pr) => {
              filterArray.push(new sap.ui.model.Filter("DescrizioneRaggruppamento", sap.ui.model.FilterOperator.EQ, pr));
          });
